            ...
            while (mituTehetCounter < mituTehet)
            {
                ...
                */
                ...
                if (katseCounter == 5)
                {
                    ...
                    Console.WriteLine("Eksisid viiel korral! Õige vastus oleks olnud " +oigeVastus);
                    Console.ReadKey();
                    Environment.Exit(0);


                }
                else if (vastus == oigeVastus)
                {
                ...
                {
                    Console.WriteLine("Sinu vastus polnud õige, proovi uuesti!");
                    Console.WriteLine("Vajuta suvalist klahvi, et jätkata...");
                    Console.WriteLine();
                    Console.ReadKey();
                    wrongAnswerCounter++;
